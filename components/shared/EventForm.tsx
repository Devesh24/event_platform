"use client"
// This component will be used as the create event form as well as the update event form 
...
const EventForm = ({userId, type, event, eventId}: EventFormProps) => {
    ...
    async function onSubmit(values: z.infer<typeof EventFormSchema>) {
        ...
        //we are uploading the image on the uploadthing server and use that link into our DB and not the original image path
                    ...
                    <FormItem className="w-full">
                        <FormControl>
                            <div className="flex-center h-[55px] w-full overflow-hidden rounded-full bg-grey-50 px-4 py-2">
                                ...
                                <DatePicker selected={field.value} onChange={(date: Date | null) => field.onChange(date)} showTimeSelect timeInputLabel="Time:" dateFormat={"dd/MM/yyyy h:mm aa"} wrapperClassName="datePicker" />
                            </div>
                        </FormControl>
                        <FormMessage />
                    </FormItem>
