...
export const createEvent = async ({event, userId, path}: CreateEventParams) => {
    try {
        ...
        if(!organizer) throw new Error('Organizer does not Exist')
...
export const getEventById = async (id: string) => {
    try {
        ...
        //since we need to populate the event with the user and category details, we do it in another function and wrap the findById query in it.
