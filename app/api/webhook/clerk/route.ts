...
//---------------------------------------updates-------------------------------------------
  ...
  if (eventType === "user.created") {
    ...
    const user = {
      ...
      username: username!, // '!' implies username can be a string or null
      firstName: first_name!, // '!' implies firstName can be a string or null
      lastName: last_name!, // '!' implies lastName can be a string or null
      photo: image_url,
    };
